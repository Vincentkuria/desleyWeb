...
const {data, status,pending, error, refresh, clear } =await useFetch('http://159.65.23.208/api/employees',
    {
        method:'GET',
...
async function createEmployee() {
    ...
    //create customer
    const data= await $fetch('http://159.65.23.208/api/employees',
    {
        method:'POST',
        params:params,
        headers:{Accept:'application/vnd.api+json',Authorization:'Bearer '+localStorage.getItem('token')},
...
async function changePassword() {
    ...
    if (confirmPassword.value!=null && newPassword.value!=null) {
        ...
        const data = await $fetch('http://159.65.23.208/api/update-emp-password',
            {
                method:'POST',
                headers:{Accept:'application/vnd.api+json',Authorization:'Bearer '+localStorage.getItem('token')},
                params:{
...
if (searchQuery.value) {
    const data= await $fetch('http://159.65.23.208/api/search-employees-name',
        {
            method:'GET',
...
async function employeeApprove(id) {
    ...
    const data =await $fetch('http://159.65.23.208/api/approve-employees',
        {
            method:'POST',
            params:{id:id},
            headers:{Accept:'application/vnd.api+json',Authorization:'Bearer '+localStorage.getItem('token')},
...
async function employeeDelete(id) {
    ...
    const data= await $fetch('http://159.65.23.208/api/employees/'+id,
        {
            method:'DELETE',
            headers:{Accept:'application/vnd.api+json',Authorization:'Bearer '+localStorage.getItem('token')},
            onResponse({response}){
...
async function updateEmployee() {
    ...
    const data= await $fetch('http://159.65.23.208/api/employees/'+popItemId.value,
        {
            method:'PATCH',
            params:params,
            headers:{Accept:'application/vnd.api+json',Authorization:'Bearer '+localStorage.getItem('token')},
